...
namespace draw
{
  class EventDrawer
  {
    public:
      ...
      void DrawEvent(const TG4Event& data, const TGeoManager& man, mygl::Viewer& viewer, mygl::VisID& nextID) //Remove old objects and draw new ones
      {
        doDrawEvent(data, man, viewer, nextID);
      }
