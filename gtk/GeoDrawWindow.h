...
#include "GeoDrawer.cpp"
#include "gl/camera/GLCameraArea.cpp"
...
namespace evd
{
  class GeoDrawWindow: public Gtk::ApplicationWindow 
  {
    public: 
      GeoDrawWindow(const std::string& fileName);
      virtual ~GeoDrawWindow() = default;
    ...
    protected:
      ...
      mygl::GLCameraArea<mygl::GeoDrawer> fArea;
